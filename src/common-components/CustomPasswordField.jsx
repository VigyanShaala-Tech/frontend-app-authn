...
const PasswordField = (props) => {
  ...
  // Decide whether to use floating or fixed label
  const useFloating = !!props.floatingLabel && props.floatingLabel.trim() !== '';
  const labelText = props.label || props.floatingLabel || 'Password';
    ...
    <Form.Group controlId={props.name} isInvalid={props.errorMessage !== ''}>
      ...
      <OverlayTrigger key="tooltip" placement={placement} overlay={tooltip} show={showTooltip}>
        <Form.Control
          ...
          {...(useFloating ? { floatingLabel: props.floatingLabel } : {})}
        />
      </OverlayTrigger>
      {props.errorMessage !== '' && (
