...
const messages = defineMessages({
  ...
  'logistration.dont.have.account': {
    id: 'logistration.dont.have.account',
    defaultMessage: "Don't have an account?",
    description: 'Text shown above sign-up link on login page',
  },
  'logistration.sign.up.link': {
    id: 'logistration.sign.up.link',
    defaultMessage: 'Sign Up',
    description: 'Link text to switch to registration from login page',
  },
  ...
  'logistration.signin.terms.agreement.privacy': {
    id: 'logistration.signin.terms.agreement.privacy',
  ...
  'logistration.already.have.account': {
    ...
    description: 'Text shown above sign-in link on registration page',
  },
});
